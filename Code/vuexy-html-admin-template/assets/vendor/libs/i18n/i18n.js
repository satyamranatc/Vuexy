                    ...
                    ! function(t) {
                        ! function(e) {
                            ...
                            function w(t, e) {
                                ...
                                if (this.credentials = e.credentials || this.credentials || "same-origin", !e.headers && this.headers || (this.headers = new f(e.headers)), this.method = (n = (o = e.method || this.method || "GET").toUpperCase(), v.indexOf(n) > -1 ? n : o), this.mode = e.mode || this.mode || null, this.signal = e.signal || this.signal, this.referrer = null, ("GET" === this.method || "HEAD" === this.method) && i) throw new TypeError("Body not allowed for GET or HEAD requests");
        ...
        return function() {
                ...
                translate(t, e, o) {
                    ...
                    if (y && h && "string" != typeof h && "boolean" != typeof h && "number" != typeof h && ["[object Number]", "[object Function]", "[object RegExp]"].indexOf(d) < 0 && ("string" != typeof g || "[object Array]" !== d)) {
                        if (!e.returnObjects && !this.options.returnObjects) {
                            ...
                            const t = this.options.returnedObjectHandler ? this.options.returnedObjectHandler(p, h, { ...e,
                                ns: s
                        ...
                        !this.isValidLookup(h) && p && (n = !0, h = g), this.isValidLookup(h) || (s = !0, h = r);
                        ...
                        if (s || n || m) {
                            if (this.logger.log(m ? "updateKey" : "missingKey", l, a, r, m ? g : h), i) {
                            ...
                            const n = (t, o, n) => {
                                const i = p && n !== h ? n : y;
                                this.options.missingKeyHandler ? this.options.missingKeyHandler(t, a, o, i, m, e) : this.backendConnector && this.backendConnector.saveMissing && this.backendConnector.saveMissing(t, a, o, i, m, e), this.emit("missingKey", t, a, o, h)
                            };
            ...
            class N {
                ...
                interpolate(t, e, o, n) {
                    ...
                    const c = t => {
                        if (t.indexOf(this.formatSeparator) < 0) {
                            ...
                            return this.alwaysFormat ? this.format(i, void 0, o, { ...n,
                                ...e,
                                interpolationkey: t
                            }) : i
                        }
                        ...
                        return this.format(C(e, l, r, this.options.keySeparator, this.options.ignoreJSONStructure), s, o, { ...n,
                            ...e,
                            interpolationkey: r
                        })
                    };
                ...
                nest(t, e) {
                    ...
                    for (; o = this.nestingRegexp.exec(t);) {
                        ...
                        "string" != typeof n && (n = a(n)), n || (this.logger.warn(`missed to resolve ${o[1]} for nesting ${t}`), n = ""), u && (n = l.reduce(((t, e) => this.format(t, e, r.lng, { ...r,
            ...
            class F extends n {
                ...
                cloneInstance() {
                    ...
                    }, o && (i.store = new b(this.store.data, n), i.services.resourceStore = i.store), i.translator = new x(i.services, n), i.translator.on("*", (function(t) {
                        for (var e = arguments.length, o = new Array(e > 1 ? e - 1 : 0), n = 1; n < e; n++) o[n - 1] = arguments[n];
                        i.emit(t, ...o)
            ...
            var Q = function(t, e) {
                ...
                tt = !1,
                et = function(t, e, o, n) {
                    return "function" == typeof o && (n = o, o = void 0), n = n || function() {}, J && 0 !== e.indexOf("file:") ? function(t, e, o, n) {
                        ...
                        try {
                            var i;
                            (i = z ? new z : new X("MSXML2.XMLHTTP.3.0")).open(o ? "POST" : "GET", e, 1), t.crossDomain || i.setRequestHeader("X-Requested-With", "XMLHttpRequest"), i.withCredentials = !!t.withCredentials, o && i.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), i.overrideMimeType && i.overrideMimeType("application/json");
                ...
                return e = t, o = [{
                    ...
                    value: function(t) {
                        var e = this,
                            ...
                            n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
                        this.services = t, this.options = V(o, this.options || {}, {
                    ...
                    return e = t, o = [{
                        ...
                        value: function(t) {
                            ...
                            this.services = t || {
                                ...
                                return t.replace("-", "_")
                            }), this.options.lookupFromUrlIndex && (this.options.lookupFromPathIndex = this.options.lookupFromUrlIndex), this.i18nOptions = o, this.addDetector(dt), this.addDetector(gt), this.addDetector(bt), this.addDetector(xt), this.addDetector(St), this.addDetector(kt), this.addDetector(Ot), this.addDetector(Lt)
                        }
                    }, {
                        key: "addDetector",
                        value: function(t) {
