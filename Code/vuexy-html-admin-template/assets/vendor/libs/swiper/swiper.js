! function(e, t) {
    ...
    return function() {
        ...
        function N(e) {
            ...
            if ("touchstart" === a.type) return void H(t, a, a.targetTouches[0].pageX);
            const {
                params: n,
                touches: o,
                enabled: d
        ...
        function Y(e) {
            ...
            let E = !0,
                x = i.resistanceRatio;
            if (i.touchReleaseOnEdges && (x = 0), g > 0 ? (b && y && a.allowThresholdMove && a.currentTranslate > (i.centeredSlides ? s.minTranslate() - s.slidesSizesGrid[s.activeIndex + 1] : s.minTranslate()) && s.loopFix({
                    direction: "prev",
                    setTranslate: !0,
                    activeSlideIndex: 0
                }), a.currentTranslate > s.minTranslate() && (E = !1, i.resistance && (a.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + a.startTranslate + g) ** x))) : g < 0 && (b && y && a.allowThresholdMove && a.currentTranslate < (i.centeredSlides ? s.maxTranslate() + s.slidesSizesGrid[s.slidesSizesGrid.length - 1] : s.maxTranslate()) && s.loopFix({
                    direction: "next",
                    setTranslate: !0,
        ...
        const j = (e, t) => {
                ...
                s[d]("touchstart", e.onDocumentTouchStart, {
                    ...
                    passive: !0
                }), (a.preventClicks || a.preventClicksPropagation) && i[d]("click", e.onClick, !0), a.cssMode && n[d]("scroll", e.onScroll), a.updateOnWindowResize ? e[c](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", R, !0) : e[c]("observerUpdate", R, !0), i[d]("load", e.onLoad, {
                    capture: !0
                })
            },
        ...
        const Z = {
                ...
                events: {
                    attachEvents: function() {
                        ...
                        e.onTouchStart = N.bind(e), e.onTouchMove = Y.bind(e), e.onTouchEnd = B.bind(e), e.onDocumentTouchStart = F.bind(e), t.cssMode && (e.onScroll = V.bind(e)), e.onClick = q.bind(e), e.onLoad = _.bind(e), j(e, "on")
                    },
                ...
                breakpoints: {
                    setBreakpoint: function() {
                        ...
                        }), c && !f ? e.disable() : !c && f && e.enable(), e.currentBreakpoint = n, e.emit("_beforeBreakpoint", l), s && (u ? (e.loopDestroy(), e.loopCreate(t), e.updateSlides()) : !h && g ? (e.loopCreate(t), e.updateSlides()) : h && !g && e.loopDestroy()), e.emit("breakpoint", l)
                    },
        ...
        class J {
            constructor() {
                ...
                const o = this;
                var d;
                o.__swiper__ = !0, o.support = A(), o.device = (void 0 === (d = {
                ...
                const p = m({}, U, c);
                return o.params = m({}, p, Q, t), o.originalParams = m({}, o.params), o.passedParams = m({}, t), o.params && o.params.on && Object.keys(o.params.on).forEach((e => {
        ...
        const pe = [function(e) {
            ...
            function c(e) {
                ...
                if (r && f >= b ? (y -= b, i || (x += s.slidesGrid[0])) : r && f < b && (y = -b, i && (x += s.slidesGrid[0])), Object.assign(s.virtual, {
                        from: y,
                        to: E,
                        offset: x,
            ...
            function u() {
                ...
                if (t.params.loop ? (r = t.previousRealIndex || 0, a = t.params.slidesPerGroup > 1 ? Math.floor(t.realIndex / t.params.slidesPerGroup) : t.realIndex) : void 0 !== t.snapIndex ? (a = t.snapIndex, r = t.previousSnapIndex) : (r = t.previousIndex || 0, a = t.activeIndex || 0), "bullets" === s.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
                    ...
                    let o, d, u;
                    if (s.dynamicBullets && (n = M(i[0], t.isHorizontal() ? "width" : "height", !0), p.forEach((e => {
            ...
            function C() {
                ...
                t.params.uniqueNavElements && "string" == typeof a.el && i.length > 1 && 1 === s.querySelectorAll(a.el).length && (i = s.querySelector(a.el)), i.length > 0 && (i = i[0]), i.classList.add(t.isHorizontal() ? a.horizontalClass : a.verticalClass), i && (r = i.querySelector(te(t.params.scrollbar.dragClass)), r || (r = b("div", t.params.scrollbar.dragClass), i.append(r))), Object.assign(e, {
                    el: i,
                    dragEl: r
            ...
            function x(e) {
                ...
                i >= 0 && (u[i] = e), u.length < 2 || (o = !0, m.scaleMove = w(), m.imageEl && (a.scale = m.scaleMove / m.scaleStart * d, a.scale > m.maxRatio && (a.scale = m.maxRatio - 1 + (a.scale - m.maxRatio + 1) ** .5), a.scale < s.minRatio && (a.scale = s.minRatio + 1 - (s.minRatio - a.scale + 1) ** .5), m.imageEl.style.transform = `translate3d(0,0,0) scale(${a.scale})`))
            }
            ...
            function M(e) {
                ...
                h.isMoved || (h.width = m.imageEl.offsetWidth, h.height = m.imageEl.offsetHeight, h.startX = p(m.imageWrapEl, "x") || 0, h.startY = p(m.imageWrapEl, "y") || 0, m.slideWidth = m.slideEl.offsetWidth, m.slideHeight = m.slideEl.offsetHeight, m.imageWrapEl.style.transitionDuration = "0ms");
                const a = h.width * s.scale,
                    i = h.height * s.scale;
                if (a < m.slideWidth && i < m.slideHeight) return;
                if (h.minX = Math.min(m.slideWidth / 2 - a / 2, 0), h.maxX = -h.minX, h.minY = Math.min(m.slideHeight / 2 - i / 2, 0), h.maxY = -h.minY, h.touchesCurrent.x = u.length > 0 ? u[0].pageX : e.pageX, h.touchesCurrent.y = u.length > 0 ? u[0].pageY : e.pageY, Math.max(Math.abs(h.touchesCurrent.x - h.touchesStart.x), Math.abs(h.touchesCurrent.y - h.touchesStart.y)) > 5 && (t.allowClick = !1), !h.isMoved && !c) {
            ...
            function P(e) {
                ...
                1 === d && A && (i = void 0, n = void 0), s.scale = A || m.imageWrapEl.getAttribute("data-swiper-zoom") || a.maxRatio, d = A || m.imageWrapEl.getAttribute("data-swiper-zoom") || a.maxRatio, !e || 1 === d && A ? (u = 0, f = 0) : (P = m.slideEl.offsetWidth, L = m.slideEl.offsetHeight, l = y(m.slideEl).left + r.scrollX, o = y(m.slideEl).top + r.scrollY, c = l + P / 2 - i, p = o + L / 2 - n, g = m.imageEl.offsetWidth, w = m.imageEl.offsetHeight, b = g * s.scale, E = w * s.scale, x = Math.min(P / 2 - b / 2, 0), T = Math.min(L / 2 - E / 2, 0), M = -x, C = -T, u = c * s.scale, f = p * s.scale, u < x && (u = x), u > M && (u = M), f < T && (f = T), f > C && (f = C)), A && 1 === s.scale && (m.originX = 0, m.originY = 0), m.imageWrapEl.style.transitionDuration = "300ms", m.imageWrapEl.style.transform = `translate3d(${u}px, ${f}px,0)`, m.imageEl.style.transitionDuration = "300ms", m.imageEl.style.transform = `translate3d(0,0,0) scale(${s.scale})`
            }
            ...
            function z() {
                ...
                t.wrapperEl.addEventListener("pointerdown", E, s), t.wrapperEl.addEventListener("pointermove", x, a), ["pointerup", "pointercancel", "pointerout"].forEach((e => {
            ...
            function $() {
                ...
                t.wrapperEl.removeEventListener("pointerdown", E, s), t.wrapperEl.removeEventListener("pointermove", x, a), ["pointerup", "pointercancel", "pointerout"].forEach((e => {
            ...
            a("beforeInit", (() => {
                ...
                t.params.a11y.enabled && (() => {
                    ...
                    u = n(u), m = n(m), u && u.forEach((t => v(t, r, e.nextSlideMessage))), m && m.forEach((t => v(t, r, e.prevSlideMessage))), g() && n(t.pagination.el).forEach((e => {
                        e.addEventListener("keydown", h)
                    })), t.el.addEventListener("focus", E, !0), t.el.addEventListener("pointerdown", w, !0), t.el.addEventListener("pointerup", y, !0)
                })()
                ...
                t.params.a11y.enabled && function() {
                    ...
                    f() && t.pagination.bullets.forEach((s => {
                        t.params.pagination.clickable && (l(s), t.params.pagination.renderBullet || (d(s, "button"), p(s, e.paginationBulletMessage.replace(/\{\{index\}\}/, x(s) + 1)))), s.matches(te(t.params.pagination.bulletActiveClass)) ? s.setAttribute("aria-current", "true") : s.removeAttribute("aria-current")
                    }))
                }()
            })), a("destroy", (() => {
                t.params.a11y.enabled && function() {
                    ...
                    })), t.el.removeEventListener("focus", E, !0), t.el.removeEventListener("pointerdown", w, !0), t.el.removeEventListener("pointerup", y, !0)
                }()
            }))
        }, function(e) {
            let {
            ...
            n("init", (() => {
                a.params.autoplay.enabled && (a.params.autoplay.pauseOnMouseEnter && (a.el.addEventListener("pointerenter", L), a.el.addEventListener("pointerleave", A)), r().addEventListener("visibilitychange", P), S())
            })), n("destroy", (() => {
                a.el.removeEventListener("pointerenter", L), a.el.removeEventListener("pointerleave", A), r().removeEventListener("visibilitychange", P), a.autoplay.running && T()
            ...
            le({
                ...
                setTranslate: () => {
                    ...
                    let m, h = 0;
                    c.shadow && (p ? (m = t.wrapperEl.querySelector(".swiper-cube-shadow"), m || (m = b("div", "swiper-cube-shadow"), t.wrapperEl.append(m)), m.style.height = `${r}px`) : (m = e.querySelector(".swiper-cube-shadow"), m || (m = b("div", "swiper-cube-shadow"), e.append(m))));
                    for (let e = 0; e < a.length; e += 1) {
                        const s = a[e];
                        let r = e;
            ...
            s({
                ...
                setTranslate: () => {
                    ...
                    for (let e = 0, s = a.length; e < s; e += 1) {
                        ...
                        if (oe(0, s).style.transform = y, s.style.zIndex = 1 - Math.abs(Math.round(u)), r.slideShadows) {
                ...
                setTranslate: () => {
                    ...
                    for (let s = 0; s < e.length; s += 1) {
                        ...
                        if (h && f.shadow || !h) {
                            ...
                            if (!e && f.shadow && (e = ce("creative", a)), e) {
